...
function Overview() {
    return (
        <div className="uk-container">
            <a name="Overview"></a>
            <div class="uk-grid-medium uk-container-small uk-child-width-expand@s uk-grid-match uk-column-1-2 uk-text-center" uk-grid>
                <div className="uk-container">
                    <img className="myImg" src={NewImg} alt="Me" />
                </div>
                <div className="aboutMe uk-container">
